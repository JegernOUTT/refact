...
pub struct ChatSession {
    ...
    pub interruptible_waits: usize,
    pub wait_delivery_boundary: bool,
    pub wait_interrupt_flag: Arc<AtomicBool>,
    ...
    pub cache_guard_snapshot_generation: u64,
    pub cache_guard_reset_generation: u64,
