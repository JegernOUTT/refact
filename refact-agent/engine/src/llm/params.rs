...
mod tests {
    ...
    fn test_reasoning_intent_openai() {
        ...
        assert_eq!(ReasoningIntent::BudgetTokens(5000).to_openai_effort(), Some("high"));
    }
    ...
    fn test_reasoning_intent_anthropic() {
        ...
        assert_eq!(ReasoningIntent::Medium.to_anthropic_budget(10000), Some(5000));
        assert_eq!(ReasoningIntent::High.to_anthropic_budget(10000), Some(10000));
        assert_eq!(ReasoningIntent::BudgetTokens(8000).to_anthropic_budget(10000), Some(8000));
    }
}
