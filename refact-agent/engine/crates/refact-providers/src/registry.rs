...
use crate::{
    ...
    xai::XAIProvider, xai_responses::XAIResponsesProvider, xai_oauth::XAIOAuthProvider,
    google_gemini::GoogleGeminiProvider,
    google_antigravity::GoogleAntigravityProvider,
...
pub fn create_provider(name: &str) -> Option<Box<dyn ProviderTrait>> {
    match name {
        ...
        "xai_oauth" => Some(Box::new(XAIOAuthProvider::default())),
        "google_gemini" => Some(Box::new(GoogleGeminiProvider::default())),
        "google_antigravity" => Some(Box::new(GoogleAntigravityProvider::default())),
