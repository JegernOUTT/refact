...
mod rules {
    ...
    fn fact_diagnostic_ids(fact: &crate::types::BuddyFact) -> Vec<String> {
        fact.payload
            .get("diagnostic_ids")
    ...
    fn payload_strings(fact: &crate::types::BuddyFact, key: &str) -> Vec<String> {
        fact.payload
            .get(key)
            .and_then(|v| v.as_array())
            .map(|arr| {
...
impl OpportunityDetector {
    ...
    pub fn detect(
        &self,
        fact_store: &crate::facts::FactStore,
        pulse: &BuddyPulse,
