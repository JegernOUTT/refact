(function() {
    ...
    try {
        var stale = document.getElementById('__refact_toolbar_host');
        ...
        var icons = {
            ...
            pick_element: '<svg viewBox="0 0 24 24"><path d="M3 3l7.5 18 2.2-7.3L20 11.5z"/><path d="M13 13l6 6"/></svg>',
        ...
        var setAnnotateActive = function(active) {
            try {
        ...
        var confirmInstalled = function() {
            if (!document.body || !document.body.contains(host)) return false;
            window.__refact_toolbar_setCounts = setCounts;
            window.__refact_toolbar_setAnnotateActive = setAnnotateActive;
            window.__refact_toolbar_blocked = null;
        ...
        if (document.body) {
            ...
            if (!confirmInstalled()) {
                window.__refact_toolbar_blocked = 'mount_rejected';
            }
        } else {
            document.addEventListener('DOMContentLoaded', function() {
                try {
                    ...
                    window.__refact_toolbar_blocked = 'csp';
                }
            }, { once: true });
        }
    } catch(e) {
