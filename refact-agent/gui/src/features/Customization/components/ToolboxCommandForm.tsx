  ...
  return (
    <Flex direction="column" gap="4">
      ...
      <Flex direction="column" gap="3">
        <Text size="2" weight="medium">Selection Requirements</Text>
        ...
        {hasSelectionRange && (
          <Flex gap="3" align="center">
            <Flex direction="column" gap="1">
              <Text size="1" color="gray">Min chars</Text>
              <TextField.Root
                type="number"
        ...
        {!hasSelectionRange && (
          <Flex align="center" gap="2">
            <Switch
              ...
              onCheckedChange={(checked) => patch(["selection_unwanted"], checked)}
            />
            <Text size="2">Selection Unwanted</Text>
            <Text size="1" color="gray">(hide command when text is selected)</Text>
          </Flex>
        )}
      </Flex>
      ...
      <Flex align="center" gap="2">
        ...
        <Text size="1" color="gray">(insert response at cursor position)</Text>
      </Flex>
