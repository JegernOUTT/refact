...
function makeRuntime(id: "thread-A" | "thread-B"): ChatThreadRuntime {
  ...
  return {
    thread: {
      ...
      auto_compression_cap: isA ? 6000 : 12000,
...
const selectorCases: {
  ...
  {
    name: "selectAutoCompressionCap",
    select: selectAutoCompressionCap,
    selectById: selectAutoCompressionCapById,
    expectedThreadB: 12000,
  },
  {
