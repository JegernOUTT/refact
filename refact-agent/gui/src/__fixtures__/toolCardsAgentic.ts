...
export const SUBAGENT_MESSAGES: ChatMessages = [
  ...
  },
  {
    ...
    extra: {
      ...
      goal_summary: "Trace the tool-result rendering flow",
      plan_present: true,
      worktree_branch: "refact/subagent/tool-results",
      merge_status: "merged",
      pending_questions: 0,
      questions: [],
      tokens_used: 842,
...
export const DELEGATE_MESSAGES: ChatMessages = [
  ...
  },
  {
    ...
    extra: {
      ...
      goal_summary: null,
      plan_present: false,
      worktree_branch: "refact/subagent/a11y",
      merge_status: "conflict",
      pending_questions: 1,
      questions: [
        {
          id: "a11y-approach",
          text: "Should the label wording prioritize action or context?",
