...
export declare const knowledgeGraphApi: Api<BaseQueryFn<string | FetchArgs, unknown, FetchBaseQueryError, {}, FetchBaseQueryMeta>, {
...
}, "knowledgeGraphApi", "KnowledgeGraph" | "Memory", typeof coreModuleName | typeof reactHooksModuleName>;
export declare const useGetKnowledgeGraphQuery: <R extends Record<string, any> = TSHelpersId<(Omit<{
    ...
    currentData?: KnowledgeGraphResponse | undefined;
...
}, useUpdateMemoryMutation: <R extends Record<string, any> = ({
    requestId?: undefined;
    status: QueryStatus.uninitialized;
    data?: undefined;
    error?: undefined;
    ...
    kind: string;
    filenames: string[];
}, BaseQueryFn<string | FetchArgs, unknown, FetchBaseQueryError, {}, FetchBaseQueryMeta>, "KnowledgeGraph" | "Memory", SuccessResponse, "knowledgeGraphApi">>, TSHelpersNoInfer<R> & {
    originalArgs?: {
        file_path: string;
        title?: string;
        content: string;
