...
import { Action, StoreEnhancer, UnknownAction } from 'redux';
...
import { EnhancedStore, Tuple, UnsubscribeListener } from '@reduxjs/toolkit';
import { ReactElement } from "react";
import { Matcher, SelectorMatcherOptions, waitForOptions, MatcherOptions, ByRoleMatcher, ByRoleOptions, RenderOptions } from '@testing-library/react';
import { AppStore, RootState } from "../app/store";
import type { ChatThreadRuntime } from "../features/Chat/Thread/types";
export declare const createDefaultChatState: () => {
    current_thread_id: string;
    open_thread_ids: string[];
    threads: {
        [x: string]: ChatThreadRuntime;
    };
    system_prompt: {};
    tool_use: "explore";
...
declare const customRender: (ui: ReactElement, options?: ExtendedRenderOptions) => {
    store: EnhancedStore<{
    ...
    } & PersistPartial, Action, Tuple<[StoreEnhancer<{
        ...
        } & PersistPartial, undefined, UnknownAction>;
    }>, StoreEnhancer]>>;
    user: UserEvent;
    container: HTMLElement;
    baseElement: HTMLElement;
    debug: (baseElement?: ReactDOMClient.Container | (Element | Document) | Array<ReactDOMClient.Container | (Element | Document)>, maxLength?: number, options?: OptionsReceived) => void;
    ...
    findAllByLabelText: (id: Matcher, options?: SelectorMatcherOptions | undefined, waitForElementOptions?: waitForOptions | undefined) => Promise<HTMLElement[]>;
    getByPlaceholderText: (id: Matcher, options?: MatcherOptions | undefined) => HTMLElement;
    getAllByPlaceholderText: (id: Matcher, options?: MatcherOptions | undefined) => HTMLElement[];
    queryByPlaceholderText: (id: Matcher, options?: MatcherOptions | undefined) => HTMLElement | null;
    queryAllByPlaceholderText: (id: Matcher, options?: MatcherOptions | undefined) => HTMLElement[];
    findByPlaceholderText: (id: Matcher, options?: MatcherOptions | undefined, waitForElementOptions?: waitForOptions | undefined) => Promise<HTMLElement>;
    findAllByPlaceholderText: (id: Matcher, options?: MatcherOptions | undefined, waitForElementOptions?: waitForOptions | undefined) => Promise<HTMLElement[]>;
    ...
    findAllByText: (id: Matcher, options?: SelectorMatcherOptions | undefined, waitForElementOptions?: waitForOptions | undefined) => Promise<HTMLElement[]>;
    getByAltText: (id: Matcher, options?: MatcherOptions | undefined) => HTMLElement;
    getAllByAltText: (id: Matcher, options?: MatcherOptions | undefined) => HTMLElement[];
    queryByAltText: (id: Matcher, options?: MatcherOptions | undefined) => HTMLElement | null;
    queryAllByAltText: (id: Matcher, options?: MatcherOptions | undefined) => HTMLElement[];
    findByAltText: (id: Matcher, options?: MatcherOptions | undefined, waitForElementOptions?: waitForOptions | undefined) => Promise<HTMLElement>;
    findAllByAltText: (id: Matcher, options?: MatcherOptions | undefined, waitForElementOptions?: waitForOptions | undefined) => Promise<HTMLElement[]>;
    ...
    queryByTitle: (id: Matcher, options?: MatcherOptions | undefined) => HTMLElement | null;
    queryAllByTitle: (id: Matcher, options?: MatcherOptions | undefined) => HTMLElement[];
    findByTitle: (id: Matcher, options?: MatcherOptions | undefined, waitForElementOptions?: waitForOptions | undefined) => Promise<HTMLElement>;
    findAllByTitle: (id: Matcher, options?: MatcherOptions | undefined, waitForElementOptions?: waitForOptions | undefined) => Promise<HTMLElement[]>;
    getByDisplayValue: (id: Matcher, options?: MatcherOptions | undefined) => HTMLElement;
    getAllByDisplayValue: (id: Matcher, options?: MatcherOptions | undefined) => HTMLElement[];
    queryByDisplayValue: (id: Matcher, options?: MatcherOptions | undefined) => HTMLElement | null;
    queryAllByDisplayValue: (id: Matcher, options?: MatcherOptions | undefined) => HTMLElement[];
    findByDisplayValue: (id: Matcher, options?: MatcherOptions | undefined, waitForElementOptions?: waitForOptions | undefined) => Promise<HTMLElement>;
    findAllByDisplayValue: (id: Matcher, options?: MatcherOptions | undefined, waitForElementOptions?: waitForOptions | undefined) => Promise<HTMLElement[]>;
    ...
    queryAllByRole: (role: ByRoleMatcher, options?: ByRoleOptions | undefined) => HTMLElement[];
    ...
    findAllByRole: (role: ByRoleMatcher, options?: ByRoleOptions | undefined, waitForElementOptions?: waitForOptions | undefined) => Promise<HTMLElement[]>;
    getByTestId: (id: Matcher, options?: MatcherOptions | undefined) => HTMLElement;
    getAllByTestId: (id: Matcher, options?: MatcherOptions | undefined) => HTMLElement[];
...
export declare function postMessage(data: unknown): boolean;
export declare function stubResizeObserver(): void;
/**
 ...
 *
 */
export declare const repeat: (n: number) => number[];
export declare function stubIntersectionObserver(): void;
