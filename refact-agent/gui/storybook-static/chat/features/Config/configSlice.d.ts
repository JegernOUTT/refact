...
import { BuddySnapshot, BuddySettings, BuddyCareRequest, BuddyCareResponse, BuddyQuestAcceptResponse, BuddyPersonalityRerollResponse, BuddyActivityEntry, BuddyConversationEntry, BuddyConversationMeta, OpportunityStatus, BuddyOpportunity, BuddyOpportunityAcceptResponse, BuddyPulse, BuddyDraft } from '../Buddy/types';
...
import { PreviewCheckpointsPayload, PreviewCheckpointsResponse, RestoreCheckpointsPayload, RestoreCheckpointsResponse } from '../Checkpoints/types';
import { EngineApiConfig } from '../../services/refact/apiUrl';
import { CapsResponse, ToolEditResult } from '../../events';
import { StatsSummary, StatsEventsParams, StatsEventsResponse } from '../StatsDashboard';
import { Chat } from '../Chat/Thread';
import { SidebarState } from '../Sidebar/sidebarSlice';
import { CurrentProjectInfo } from '../Chat/currentProject';
import { FileInfo, Snippet } from '../Chat';
import { PersistPartial } from 'redux-persist/es/persistReducer';
import { TipOfTheDayState } from '../TipOfTheDay';
import { SchedulerState } from '../Scheduler/schedulerSlice';
import { NotificationsState } from '../Notifications';
import { BrowserState } from '../Browser';
import { ConnectionState } from '../Connection';
import { TasksUIState } from '../Tasks';
import { PatchMeta } from '../PatchesAndDiffsTracker/patchesAndDiffsTrackerSlice';
import { CheckpointsMeta } from '../Checkpoints/checkpointsSlice';
import { IntegrationCachedFormData } from '../Integrations';
...
import { PageSliceState } from '../Pages/pagesSlice';
import { InformationSliceState } from '../Errors/informationSlice';
import { ErrorSliceState } from '../Errors/errorsSlice';
import { BuddySliceState, BuddySettingsResponse } from '../Buddy/buddySlice';
...
export declare const updateConfig: ActionCreatorWithPayload<Partial<Config>, string>;
export declare const setThemeMode: ActionCreatorWithPayload<"light" | "inherit" | "dark", string>;
export declare const setApiKey: ActionCreatorWithPayload<string | null, string>;
export declare const changeFeature: ActionCreatorWithPayload<{
    feature: string;
    value: boolean;
}, string>;
export declare const reducer: Reducer<Config> & {
    getInitialState: () => Config;
};
export declare const selectThemeMode: (state: RootState) => "light" | "inherit" | "dark" | undefined;
export declare const selectConfig: (state: RootState) => Config;
export declare const selectLspPort: (state: RootState) => number;
export declare const selectFeatures: (state: RootState) => {
    statistics?: boolean;
    vecdb?: boolean;
    ast?: boolean;
    images?: boolean;
} | undefined;
export declare const selectVecdb: ((state: {
...
} & PersistPartial) => boolean | undefined) & {
    clearCache: () => void;
    resultsCount: () => number;
...
export declare const selectAst: ((state: {
    history: HistoryState;
    buddy: BuddySliceState;
    error: ErrorSliceState;
    information: InformationSliceState;
...
export declare const selectApiKey: (state: RootState) => string | null | undefined;
export declare const selectHost: (state: RootState) => "web" | "ide" | "vscode" | "jetbrains";
export declare const selectSubmitOption: (state: RootState) => boolean;
