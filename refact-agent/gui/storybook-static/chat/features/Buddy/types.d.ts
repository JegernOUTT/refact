...
export type EyeStyle = "normal" | "star" | "heart" | "spiral" | "teary" | "angry" | "X" | "squint" | "uwu";
export type AnimType = "idle" | "work" | "think" | "absorb" | "celebrate" | "shake" | "eat" | "sleep" | "perk";
export type MoodType = "idle" | "working" | "focused" | "thinking" | "learning" | "curious" | "happy" | "celebrate" | "concerned" | "alert" | "eating" | "sleepy";
export type IdleActionType = "none" | "hover" | "curious" | "startled" | "lookBack" | "lookAround" | "stretch" | "yawn" | "tap" | "fidget" | "walk" | "playDuck" | "playDice" | "drinkCoffee" | "playBug" | "readScroll" | "doze" | "confidentPose" | "wave" | "spin" | "type_code" | "scratch" | "peekAround" | "sniff";
export type ToyType = "duck" | "dice" | "coffee" | "bug" | "scroll";
export type GroundFXType = "impact" | "crack" | "dust";
export type SignalType = "user_message" | "chat_started" | "chat_completed" | "chat_error" | "streaming" | "generating" | "tool_used" | "tool_failed" | "tool_confirmation" | "edit_applied" | "search_done" | "browser_action" | "title_generating" | "commit_msg" | "memory_extract" | "knowledge_update" | "indexing" | "vecdb_building" | "ast_parsing" | "compression" | "task_created" | "task_completed" | "task_failed" | "checkpoint_saved" | "skill_learned" | "connection_lost" | "connection_restored" | "git_changes" | "speech_humor" | "speech_insight" | "speech_chat_reaction" | "chat_bug_candidate" | "care_feed" | "care_play" | "care_pet" | "care_sleep" | "care_clean" | "idle_timeout" | "stage_up" | "error";
...
export type BuddyScenePose = "idle" | "spin" | "bounce" | "look" | "stargaze" | "meditate" | "pounce" | "dance" | "shield" | "cheer" | "carry" | "dig" | "sleepy";
export type BuddyShowcaseKind = "memory_firefly_night" | "stargazing_constellation";
export type BuddyShowcasePhase = "travel" | "anticipate" | "showcase" | "react" | "cooldown";
...
export type BuddyFactKind = "task_stuck" | "task_abandoned" | "task_cluster_duplicate" | "trajectory_clutter" | "chat_retry_streak" | "memory_orphan" | "memory_stale_conflict" | "memory_recurring_lesson" | "mode_prompt_overlap" | "skill_trigger_weak" | "agents_md_gap_detected" | "default_model_missing" | "broken_model_reference" | "mcp_auth_expired" | "integration_failing" | "diagnostic_cluster" | "frontend_error_burst" | "git_diff_widening" | "uncommitted_pressure" | "worktree_hygiene";
...
export type BuddyOpportunityKind = "task_health" | "trajectory_cleanup" | "chat_recap" | "memory_garden" | "config_drift" | "agents_md_gap" | "provider_tuning" | "integration_fix" | "diagnostic_investigation" | "git_hygiene" | "worktree_cleanup";
export type BuddyPriority = "low" | "normal" | "high" | "critical";
export type OpportunityStatus = "new" | "shown" | "dismissed" | "accepted" | "completed" | "expired";
export type DefaultsKind = "chat_model" | "chat_model_2" | "task_planner_agent_model" | "chat_light_model" | "chat_buddy_model" | "chat_thinking_model";
export type CustomizationKind = "mode" | "skill" | "command" | "delegate" | "hook";
export type MarketKind = "mcp" | "skill" | "command" | "delegate";
export type PulseScope = "all" | "tasks" | "trajectories" | "memory" | "providers" | "mcp" | "customization" | "diagnostics" | "git" | "worktrees";
...
export type DraftKind = "skill" | "command" | "delegate" | "mode" | "agents_md" | "defaults_model" | "hook" | "pulse_report";
...
export type BuddySSEEvent = {
    ...
    event_type: "ActivityAdded";
    activity: BuddyActivityEntry;
} | {
    event_type: "SuggestionAdded";
    suggestion: BuddySuggestion;
} | {
    event_type: "SuggestionDismissed";
    ...
    event_type: "DiagnosticAdded";
    diagnostic: DiagnosticContext;
} | {
    event_type: "RuntimeEvent";
    event: BuddyRuntimeEvent;
} | {
    event_type: "SpeechUpdated";
    speech: BuddySpeechItem;
} | {
    event_type: "NavigationRequest";
    page: BuddyPage;
} | {
    event_type: "OpportunityProduced";
    ...
    event_type: "PulseUpdated";
    pulse: BuddyPulse;
} | {
    event_type: "DraftCreated";
    draft: BuddyDraft;
} | {
    event_type: "DraftConsumed";
    draft_id: string;
} | {
    event_type: "DraftRemoved";
    draft_id: string;
};
