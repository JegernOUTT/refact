...
import { Selector, weakMapMemoize } from 'reselect';
...
export declare const patchesAndDiffsTrackerSlice: Slice<{
    patches: PatchMeta[];
}, {
    addPatchMeta: (state: WritableDraft<{
        patches: PatchMeta[];
    }>, action: PayloadAction<PatchMeta>) => void;
    removePatchMetaByFileNameIfCompleted: (state: WritableDraft<{
        patches: PatchMeta[];
    }>, action: PayloadAction<string[]>) => void;
    setStartedByFilePaths: (state: WritableDraft<{
        patches: PatchMeta[];
    }>, action: PayloadAction<string[]>) => void;
}, "patchesAndDiffsTracker", "patchesAndDiffsTracker", {
    selectAllFilePaths: (state: {
        patches: PatchMeta[];
    }) => string[];
}>;
export declare const selectAllFilePaths: Selector<{
...
export declare const selectUnsentPatchesFilePaths: ((state: {
...
export declare const selectCompletedPatchesFilePaths: ((state: {
    history: HistoryState;
    buddy: BuddySliceState;
    error: ErrorSliceState;
    information: InformationSliceState;
...
export declare const setStartedByFilePaths: ActionCreatorWithPayload<string[], "patchesAndDiffsTracker/setStartedByFilePaths">, removePatchMetaByFileNameIfCompleted: ActionCreatorWithPayload<string[], "patchesAndDiffsTracker/removePatchMetaByFileNameIfCompleted">;
