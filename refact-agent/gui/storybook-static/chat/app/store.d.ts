...
import { Reducer, Action, StoreEnhancer, UnknownAction } from 'redux';
declare const persistedReducer: Reducer<{
...
} & PersistPartial, Action>;
export type RootState = ReturnType<typeof persistedReducer>;
export declare function setUpStore(preloadedState?: Partial<RootState>): EnhancedStore<{
    history: HistoryState;
    buddy: BuddySliceState;
    error: ErrorSliceState;
    information: InformationSliceState;
...
export declare const persistor: Persistor;
