...
class Events {
    ...
    class Config {
        ...
        data class Features(val ast: Boolean, val vecdb: Boolean, val codegraph: Boolean = true, val images: Boolean? = true, val statistics: Boolean? = true, val knowledge: Boolean? = false) : BaseFeatures()
